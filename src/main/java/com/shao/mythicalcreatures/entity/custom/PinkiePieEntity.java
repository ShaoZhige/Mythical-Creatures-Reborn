...
public class PinkiePieEntity extends NeutralPonyEntity implements PlayerRideableJumping, PlayerRideable {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return TamableAnimal.createMobAttributes()
                ...
                .add(Attributes.ATTACK_DAMAGE, MythicalConfig.DATA.entityAttr("mythicalcreatures:pinkie_pie", "attack_damage")).add(Attributes.FOLLOW_RANGE, MythicalConfig.DATA.get("global_params", "follow_range", 16.0));
    }
