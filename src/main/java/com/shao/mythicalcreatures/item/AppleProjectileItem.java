...
public class AppleProjectileItem extends Item {
    public AppleProjectileItem(Properties properties) {
        super(properties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            AppleProjectileEntity projectile = new AppleProjectileEntity(level, player);
