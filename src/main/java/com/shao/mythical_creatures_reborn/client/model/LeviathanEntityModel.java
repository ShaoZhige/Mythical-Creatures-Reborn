...
public class LeviathanEntityModel extends GeoModel<LeviathanEntity> {
    private static final ResourceLocation MODEL = new ResourceLocation(MythicalCreaturesMod.MODID, "geo/leviathan.geo.json");
    private static final ResourceLocation TEXTURE = new ResourceLocation(MythicalCreaturesMod.MODID, "textures/entity/leviathan.png");
    ...
    @Override
    public ResourceLocation getModelResource(LeviathanEntity entity) {
        return MODEL;
    }
    ...
    @Override
    public ResourceLocation getAnimationResource(LeviathanEntity entity) {
        return ANIMATION;
    }
}
