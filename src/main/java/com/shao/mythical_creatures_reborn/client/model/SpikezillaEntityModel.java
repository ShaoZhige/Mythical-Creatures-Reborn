...
public class SpikezillaEntityModel extends GeoModel<SpikezillaEntity> {
    ...
    @Override
    public ResourceLocation getModelResource(SpikezillaEntity entity) {
        return MODEL;
    }

    @Override
    public ResourceLocation getTextureResource(SpikezillaEntity entity) {
        return TEXTURE;
    }

    @Override
    public ResourceLocation getAnimationResource(SpikezillaEntity entity) {
        return ANIMATION;
    }
}
