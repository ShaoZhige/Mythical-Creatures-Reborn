...
public class BalloonProjectileEntity extends ModThrowableProjectile {
    ...
    private static final String PID = "mythical_creatures_reborn:balloon_projectile";

    /** 取自配置 {@code mythical_creatures_reborn:balloon_projectile|damage}（可在配置编辑器「投掷物」分类里改） */
