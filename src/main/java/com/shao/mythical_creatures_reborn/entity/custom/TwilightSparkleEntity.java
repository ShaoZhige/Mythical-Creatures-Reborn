...
public class TwilightSparkleEntity extends NeutralPonyEntity {
    ...
    /* ── 飞行参数（慢速平稳，默认值即紫悦的风格） ── */
    @Override protected int    getFlightChance()        { return MythicalConfig.DATA.getInt("mythical_creatures_reborn:twilight_sparkle", "flight_chance", 200); }
    @Override protected int    getFlightCooldownMin()   { return MythicalConfig.DATA.getInt("mythical_creatures_reborn:twilight_sparkle", "fly_cooldown_min", 200); }
    @Override protected int    getFlightCooldownMax()   { return MythicalConfig.DATA.getInt("mythical_creatures_reborn:twilight_sparkle", "fly_cooldown_max", 400); }
    @Override protected int    getFlightDurationMin()   { return MythicalConfig.DATA.getInt("mythical_creatures_reborn:twilight_sparkle", "fly_duration_min", 100); }
