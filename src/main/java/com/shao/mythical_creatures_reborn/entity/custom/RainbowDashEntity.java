...
public class RainbowDashEntity extends NeutralPonyEntity {
    ...
    @Override protected int    getFlightChance()        { return MythicalConfig.DATA.getInt("mythical_creatures_reborn:rainbow_dash", "flight_chance", 200); }
    @Override protected int    getFlightCooldownMin()   { return MythicalConfig.DATA.getInt("mythical_creatures_reborn:rainbow_dash", "fly_cooldown_min", 100); }
    @Override protected int    getFlightCooldownMax()   { return MythicalConfig.DATA.getInt("mythical_creatures_reborn:rainbow_dash", "fly_cooldown_max", 300); }
    @Override protected int    getFlightDurationMin()   { return MythicalConfig.DATA.getInt("mythical_creatures_reborn:rainbow_dash", "fly_duration_min", 150); }
    ...
    @Override public boolean hurt(net.minecraft.world.damagesource.DamageSource source, float amount) {
        if (source.getDirectEntity() instanceof com.shao.mythical_creatures_reborn.entity.RainbowCloudEntity) return false;
